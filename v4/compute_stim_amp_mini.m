function [OUT, GP] = compute_stim_amp_mini (rel,Param, colr, flag_normalize_modes, plot_r_flag, yl, signif_display_offset, key)
...
%     stim_duration=0.4;%P.stim_duration{1,:}+0.3;
    ...
    stim_onset_vector (counter) = P.stim_onset{1,:};
