function  [xl,yl]=figure_plot_vs1_stimulus_mini(rel, k, label_flag,plot_r_flag)
...
plot(linspace(-2.5, -2.4, numel(x)),y*(factor)+21,'Color',colr{1},'LineWidth',0.5,'Clipping','off')
plot(linspace(-1.6, -1.5, numel(x)),y*(factor)+21,'Color',colr{2},'LineWidth',0.5,'Clipping','off')
plot(linspace(-0.8, -0.7, numel(x)),y*(factor)+21,'Color',colr{3},'LineWidth',0.5,'Clipping','off')
