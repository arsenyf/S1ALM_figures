function [xl, yl] = figure_plotModes3 (rel,Param, xlabel_flag, title1, title2,title3, ylabel_flag, key, mode_names_titles, y_lims, flag_normalize_modes, plot_r_flag, xl, line_style, stim_time_flag)
